...
<body>
    ...
    <nav>
        ...
        <div class="nav-left">
            ...
            <a href="Assets/Resources.php">Resources</a>
            ...
            <div class="slogan">
                ...
                <div>
                    ...
                    <div class="content-image">
                        ...
                        <img src="Assets/Images/Wheat.png" alt="Wheat">
                        
                    </div>
                    
                    <div class="content-p">
                        
                        <p>Join the harvest!</p>
                        <p>Empowering Farmers, Empowering India!</p>
...
if(isset($_POST['submit'])){
    ...
    $verify_query = mysqli_query($con,"SELECT conum FROM users WHERE conum='$number'");

    if(mysqli_num_rows($verify_query) != 0) {

        echo "<div class=\"Ar\"><div><p>Already Registered</p><div><br><a href=\"login.php\">Login</a> </div>";

    }  else {

        mysqli_query($con, "INSERT INTO users(conum,password) VALUES('$number','$password')") or die("Error: " . mysqli_error($con));

        echo "<div class=\"Ar\"><div><p>Registered Successfully</p><div><br><a href=\"login.php\">Login</a> </div>";
                ...
                <div class="login-box">
                    ...
                    <div class="center-content">
                        ...
                        <form action="" method="post">
                            ...
                            <br><br>
                            <button id="Login" name="submit">Sign Up</button>
                            <br>
